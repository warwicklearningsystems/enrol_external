...
if ($ADMIN->fulltree) {
    ...
    if (!during_initial_install()) {
        ...
        $settings->add(new admin_setting_configselect('enrol_external/unenrolaction', get_string('extremovedaction', 'enrol'), get_string('extremovedaction_help', 'enrol'), ENROL_EXT_REMOVED_UNENROL, $options));
    }
}
